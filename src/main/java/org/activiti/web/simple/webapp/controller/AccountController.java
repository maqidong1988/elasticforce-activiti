...
public class AccountController {
	...
	public String loginin(@RequestParam("username") String username,
		...
		if ((username != null && username.length() > 0)
			...
			if (b) {
				...
				List<Group> listGroup = identityService.createGroupQuery()
	 ...
	 * @return
	 */
	@RequestMapping(value = "/userwork", method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 * @return
	 */
	@RequestMapping(value = "/groupwork", method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	public ModelAndView userlist(HttpServletRequest request,
		...
		List<org.activiti.engine.identity.User> listuser = accountService
	 ...
	 * @return
	 */
	@RequestMapping(value = "/memberofgroup/{groupId}", method = {
			RequestMethod.POST, RequestMethod.GET })
	public ModelAndView memberOfGroup(@PathVariable("groupId") String groupId) {
		List<User> listMemberOfGroupUser = identityService.createUserQuery()
