...
/**
 * 不使用org.springframework.web.servlet.handler.SimpleUrlHandlerMapping标配 访问路径依次为
 * /hello/jsp /hello/velocity /hello/freemarker /hello/showUser/admin/admin
 * 
 * @author xuzw
 *
 */
...
public class HelloController {
	...
	/**
	 * 从地址栏接受参数 /hello/showUser/admin/admin name为admin pwd为admin
	 * 请求转发到showuser.jsp
	 * 
	 * @param username
	 * @param password
