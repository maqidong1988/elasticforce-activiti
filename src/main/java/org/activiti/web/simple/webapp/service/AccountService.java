...
public interface AccountService {
	...
	/**
	 * @param userId
	 *            id of user to get, cannot be null. When an id is passed for
	 *            get exist user, this operation is ignored.
	 */
	...
	*//** Get account information associated with a user *//*
	Account getUserAccount(String userId, String userPassword,
			String accountName);
