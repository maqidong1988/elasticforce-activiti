...
public class LeaveController {
	...
	public String startWorkFlow(Leave leave, HttpSession session, HttpServletRequest request,
			HttpServletResponse response, RedirectAttributes redirectAttributes) {

		Map<String, Object> variables = new HashMap<String, Object>();

		// 设定邮件发送人和邮件收件人
		variables.put("from", "42200169@qq.com");
		...
		if (user != null) {
			...
			try {
				...
				System.out.println("definitionName==="+processInstance.getProcessDefinitionName());
	...
	public ModelAndView findRunningProcessInstaces(@PathVariable("processDefinitionKey") String processDefinitionKey,
	...
	public ModelAndView findFinishedProcessInstaces(@PathVariable("processDefinitionKey") String processDefinitionKey,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public String claimTask(@PathVariable("taskId") String taskId, HttpServletRequest request,
			HttpServletResponse response, RedirectAttributes redirectAttributes, HttpSession session) {
		User user = (User) session.getAttribute("loginuser");
