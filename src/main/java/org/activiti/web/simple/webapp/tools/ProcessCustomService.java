...
public class ProcessCustomService {
	 ...
	 * @throws Exception
	 */
	private static void commitProcess(String taskId,
			Map<String, Object> variables, String activityId) throws Exception {
		if (variables == null) {
	 ...
	 * @return
	 */
	private static ActivityImpl filterNewestActivity(
			ProcessInstance processInstance, List<ActivityImpl> tempList) {
	 ...
	 * @throws Exception
	 */
	private static ActivityImpl findActivitiImpl(String taskId,
	 ...
	 *            当前任务ID
	 */
	public static List<ActivityImpl> findBackAvtivity(String taskId)
			throws Exception {
	 ...
	 * @return
	 */
	private static List<Task> findTaskListByKey(String processInstanceId,
			String key) {
